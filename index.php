...
<html lang="en">
    <head>
        <title>Daniel</title>
        <meta name="Daniel" content="Autobiography">
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div>
            <div title="This is me!">
                <h2>
                    <strong>Daniel James A. C</strong>
                </h2>
                <hr>
            </div>

            <div>
                <em>Computer Science Major</em>
            </div>
        ...
        <div>
            ...
            <table style="background-color: beige; text-align: center; font-family: cursive sans-serif;">
                <tr>
                    <th>Project Name</th>
                    <th>Start Date</th>
                </tr>
                <tr>
                    <td>Custom Linux Shell (built in c)</td>
                    <td>August 2025</td>
                </tr>
            </table>
        </div>
